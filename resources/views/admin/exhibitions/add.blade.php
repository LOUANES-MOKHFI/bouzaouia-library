                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">أضف معرض
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="box-content">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">  أضف معرض </h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body">
                                	@include('admin.includes.alerts.alerts')
                                    <form class="form" action="{{route('admin.exhibitions.store')}}"
                                          method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{old('pays')}}" id="pays"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="pays">
                                                        @error("pays")
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{old('state')}}" id="state"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="state">
                                                        @error("state")
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" value="{{old('date_from')}}" id="date_from"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="date_from">
                                                        @error("date_from")
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" value="{{old('date_to')}}" id="date_to"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="date_to">
                                                        @error("date_to")
