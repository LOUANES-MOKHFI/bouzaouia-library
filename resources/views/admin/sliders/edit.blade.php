                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل صورة
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="box-content">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">  تعديل صورة </h4>
                            </div>
                            <div class="card-content collapse show">
                                <div class="card-body">
                                	@include('admin.includes.alerts.alerts')
                                    <form class="form" action="{{route('admin.sliders.update',$slider->id)}}"
                                          method="POST"
                                        ...
                                        <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <label for="projectinput1">الحالة</label>
                                                                ...
                                                                <div class="switch primary">
                                                                        ...
                                                                        @if($slider -> is_active == 1)checked @endif
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <img src="{{asset('assets/books/sliders/'.$slider->image)}}" width="200">
                                                            </div>
                                                        </div>
                                                    </div>
